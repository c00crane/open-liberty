...
public class JwtData {
    ...
    public boolean isJwe() {
        boolean isJwe = false;
        if (builder != null) {
            isJwe = (builder.getContentEncryptionAlg() != null
                    || builder.getKeyManagementKey() != null
                    || builder.getKeyManagementAlg() != null);
        }
        if (!isJwe && jwtConfig != null) {
            isJwe = (jwtConfig.getContentEncryptionAlgorithm() != null
                    || jwtConfig.getKeyManagementKeyAlias() != null
                    || jwtConfig.getKeyManagementKeyAlgorithm() != null);
        }
        return isJwe;
    }
